    ...
    try {
      if (typeof navigator !== 'undefined' && navigator.share) {
        await navigator.share({
          title: 'Join RConnectX',
          text: 'Sign up on RConnectX with my referral link',
    ...
    >
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Invite others to RConnectX with your personal link. When they sign up, your referral count increases.
        </p>
      </div>
