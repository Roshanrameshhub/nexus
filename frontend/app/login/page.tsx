...
import { persistStreakEvent } from '@/lib/streak'
      ...
      setAuth(
        {
          ...
          streak_started_at: u.streak_started_at ?? null,
        },
        data.access_token,
        data.refresh_token
      )
      persistStreakEvent(data.streak_event)
        ...
        <div className="glass-card p-8">
          {needsVerification ? (
            <div className="space-y-6">
              <EmailVerificationPrompt email={formData.email} />
