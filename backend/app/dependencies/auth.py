...
SUSPENSION_MESSAGE = "Your account has been suspended. Please contact support."
...
async def get_current_user(
    ...
    if user.is_banned or user.is_suspended:
        raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail=SUSPENSION_MESSAGE)
